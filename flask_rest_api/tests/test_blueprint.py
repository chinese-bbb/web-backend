...
class TestBlueprint:
    ...
    def test_blueprint_multiple_registrations(self, app, openapi_version):
        ...
        The internal doc structure is modified during the reigistration process.
        If it is not deepcopied, the second registration fails.
        """
        app.config['OPENAPI_VERSION'] = openapi_version
        blp = Blueprint('test', __name__, url_prefix='/test')
    ...
    def test_blueprint_arguments_multiple(self, app, schemas, openapi_version):
        ...
        def func(document, query_args):
            return jsonify({'document': document, 'query_args': query_args})
