...
from .utils import set_status_and_headers_in_response
        ...
        def decorator(func):
            ...
            def wrapper(*args, **kwargs):
                ...
                if isinstance(result_raw, BaseResponse):
                    set_status_and_headers_in_response(result_raw, status, headers)
                    return result_raw
            ...
            wrapper._apidoc = deepupdate(deepcopy(getattr(wrapper, '_apidoc', {})), doc)
